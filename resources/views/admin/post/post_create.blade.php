                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="author_id" id="author_id">
                                        ...
                                        @foreach($authors as $auth)
                                            <option value="{{$auth->id}}">{{$auth->name_bn}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
        ...
        <div class="col-md-3">
            ...
            <div class="card">
                ...
                <div class="card-body" style="max-height: 250px; overflow-y: scroll">
                    ...
                    <div class="mb-1">
                        <input style="margin-right: 5px" id="section_7" value="7"  type="radio" name="header_order"/>
                        <label for="section_7"> Header Post 7</label>
                    </div>
                    <div class="mb-1">
                        <input style="margin-right: 5px" id="section_8" value="8"  type="radio" name="header_order"/>
                        <label for="section_8"> Header Post 8</label>
                    </div>
                    <div class="mb-1">
                        <input style="margin-right: 5px" id="section_9" value="9"  type="radio" name="header_order"/>
                        <label for="section_9"> Header Post 9</label>
                    </div>
                    <div class="mb-1">
                        <input style="margin-right: 5px" id="section_10" value="10"  type="radio" name="header_order"/>
                        <label for="section_10"> Header Post 10</label>
                    </div>
                    <div class="mb-1">
                        <input style="margin-right: 5px" id="section_11" value="11"  type="radio" name="header_order"/>
                        <label for="section_11"> Header Post 11</label>
                    </div>
                    <div class="mb-1">
                        <input style="margin-right: 5px" id="section_12" value="12"  type="radio" name="header_order"/>
                        <label for="section_12"> Header Post 12</label>
                    </div>
                    <div class="mb-1">
                        <input style="margin-right: 5px" id="section_13" value="13"  type="radio" name="header_order"/>
...
@section('js')
    ...
    <script>
        tinymce.init({
            ...
            content_style: 'body { font-size: 18pt; text-align: justify; }',
