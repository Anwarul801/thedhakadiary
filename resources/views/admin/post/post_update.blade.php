                ...
                <div class="card">
                    ...
                    <div class="card-body" style="max-height: 250px; overflow-y: scroll">
                        @foreach($sections as $section)
                            <div class="mb-1">
                                <input style="margin-right: 5px" id="section{{ $section->id }}" value="{{ $section->id }}" {{ $data_section->sections->where('id',$section->id)->first() ? "checked" : "" }} type="checkbox" name="sections[]"/>
