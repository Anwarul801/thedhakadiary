                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{old('profession')}}" class="form-control" type="text" id="profession" name="profession" required="" placeholder="Profession">
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
{{--                            </div>--}}
                        ...
                        <div class="form-group account-btn text-center">
                            <div class="col-12">
                                <button class="btn width-lg btn-rounded btn-primary" type="submit">Create Author</button>
                            </div>
                        </div>
                    </form>
                </div>
